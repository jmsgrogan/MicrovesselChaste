...
py::class_<Owen11CellPopulationGenerator3    >(m, "Owen11CellPopulationGenerator3")
        .def(py::init< >())
        .def_static(
            "Create", 
