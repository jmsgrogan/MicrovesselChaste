...
py::class_<StructuralAdaptationSolver2 , StructuralAdaptationSolver2_Overloads , std::shared_ptr<StructuralAdaptationSolver2 >  , AbstractStructuralAdaptationSolver<2>  >(m, "StructuralAdaptationSolver2")
        .def(py::init< >())
        .def_static(
            "Create", 
