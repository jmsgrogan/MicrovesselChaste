...
py::class_<Vertex2    >(m, "Vertex2")
        ...
        .def_static(
            "Create", 
            (::std::shared_ptr<Vertex<2> >(*)(::RVectorQuantity<RQuantity<std::ratio<0, 1>, std::ratio<1, 1>, std::ratio<0, 1>, std::ratio<0, 1>, std::ratio<0, 1> >, 2>)) &Vertex2::Create, 
            " " , py::arg("loc") )
        .def_static(
            "Create", 
        ...
        .def(
            "GetDistance", 
            (::QLength(Vertex2::*)(::RVectorQuantity<RQuantity<std::ratio<0, 1>, std::ratio<1, 1>, std::ratio<0, 1>, std::ratio<0, 1>, std::ratio<0, 1> >, 2> const &) const ) &Vertex2::GetDistance, 
            " " , py::arg("rLocation") )
        .def(
            "GetDistance", 
