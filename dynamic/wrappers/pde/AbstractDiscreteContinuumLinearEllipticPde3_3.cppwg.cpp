...
py::class_<AbstractDiscreteContinuumLinearEllipticPde3_3 , AbstractDiscreteContinuumLinearEllipticPde3_3_Overloads   >(m, "AbstractDiscreteContinuumLinearEllipticPde3_3")
        .def(
            "ComputeDiffusionTerm", 
