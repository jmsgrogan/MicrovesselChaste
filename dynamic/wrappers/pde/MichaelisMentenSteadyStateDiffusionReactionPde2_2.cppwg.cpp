...
py::class_<MichaelisMentenSteadyStateDiffusionReactionPde2_2 , MichaelisMentenSteadyStateDiffusionReactionPde2_2_Overloads   >(m, "MichaelisMentenSteadyStateDiffusionReactionPde2_2")
        .def(py::init< >())
        .def_static(
            "Create", 
