...
py::class_<SolutionDependentDiscreteSource2 , SolutionDependentDiscreteSource2_Overloads , std::shared_ptr<SolutionDependentDiscreteSource2 >  , DiscreteSource<2>  >(m, "SolutionDependentDiscreteSource2")
        .def(py::init< >())
        .def_static(
            "Create", 
