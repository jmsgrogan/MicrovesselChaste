...
py::class_<VesselFlowProperties3 , VesselFlowProperties3_Overloads , std::shared_ptr<VesselFlowProperties3 >  , AbstractVesselNetworkComponentFlowProperties<3>  >(m, "VesselFlowProperties3")
        .def(py::init< >())
        .def(
            "CheckSegments", 
