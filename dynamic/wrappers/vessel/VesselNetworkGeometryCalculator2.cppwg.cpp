...
py::class_<VesselNetworkGeometryCalculator2    >(m, "VesselNetworkGeometryCalculator2")
        ...
        .def_static(
            ...
            (::QLength(*)(::std::shared_ptr<VesselNetwork<2> >, ::DimensionalChastePoint<2> const &)) &VesselNetworkGeometryCalculator2::GetDistanceToNearestNode, 
        ...
        .def_static(
            "GetNearestSegment", 
            (::std::pair<std::shared_ptr<VesselSegment<2> >, RQuantity<std::ratio<0, 1>, std::ratio<1, 1>, std::ratio<0, 1>, std::ratio<0, 1>, std::ratio<0, 1> > >(*)(::std::shared_ptr<VesselNetwork<2> >, ::DimensionalChastePoint<2> const &)) &VesselNetworkGeometryCalculator2::GetNearestSegment, 
            " " , py::arg("pNetwork"), py::arg("rLocation") )
        .def_static(
            "GetNearestVessel", 
        ...
        .def_static(
            "GetNodesInSphere", 
            (::std::vector<std::shared_ptr<VesselNode<2> >, std::allocator<std::shared_ptr<VesselNode<2> > > >(*)(::std::shared_ptr<VesselNetwork<2> >, ::DimensionalChastePoint<2> const &, ::QLength)) &VesselNetworkGeometryCalculator2::GetNodesInSphere, 
