...
py::class_<CellPopulationActorGenerator3 , CellPopulationActorGenerator3_Overloads , std::shared_ptr<CellPopulationActorGenerator3 >  , AbstractActorGenerator<3>  >(m, "CellPopulationActorGenerator3")
        .def(py::init< >())
        .def(
            "AddActor", 
