...
typedef boost::shared_ptr<Polygon2 > Boostshared_ptrPolygon2;
typedef boost::shared_ptr<Polygon3 > Boostshared_ptrPolygon3;
typedef std::vector<std::vector<boost::shared_ptr<Polygon2 > > > StdvectorStdvectorboostshared_ptrPolygon2;
typedef std::vector<std::vector<boost::shared_ptr<Polygon3 > > > StdvectorStdvectorboostshared_ptrPolygon3;
typedef std::vector<boost::shared_ptr<Polygon<2> > > StdvectorBoostshared_ptrPolygon2;
typedef std::vector<boost::shared_ptr<Polygon<2> > > StdvectorBoostshared_ptrPolygon2;
typedef std::vector<boost::shared_ptr<Facet<2> > > StdvectorBoostshared_ptrFacet2;
typedef std::vector<boost::shared_ptr<Facet<3> > > StdvectorBoostshared_ptrFacet3;
typedef std::vector<boost::shared_ptr<DimensionalChastePoint<2> > > StdvectorBoostshared_ptrDimensionalChastePoint2;
typedef std::vector<boost::shared_ptr<DimensionalChastePoint<3> > > StdvectorBoostshared_ptrDimensionalChastePoint3;
...
typedef std::vector<DimensionalChastePoint<2> > StdvectorDimensionalChastePoint2;
typedef std::vector<DimensionalChastePoint<3> > StdvectorDimensionalChastePoint3;
typedef std::pair<DimensionalChastePoint<2>, DimensionalChastePoint<2> > StdpairDimensionalChastePoint2DimensionalChastePoint2;
typedef std::pair<DimensionalChastePoint<3>, DimensionalChastePoint<3> > StdpairDimensionalChastePoint3DimensionalChastePoint3;
...
typedef AbstractGreensFunctionSolverBase<2 > AbstractGreensFunctionSolverBase2;
typedef AbstractGreensFunctionSolverBase<3 > AbstractGreensFunctionSolverBase3;
typedef SimpleLinearEllipticGreensFunctionSolver<2 > SimpleLinearEllipticGreensFunctionSolver2;
typedef SimpleLinearEllipticGreensFunctionSolver<3 > SimpleLinearEllipticGreensFunctionSolver3;
...
typedef std::map<std::string,std::string > StdmapStdstring_Stdstring;
typedef std::set<unsigned > StdsetUnsigned;
typedef std::vector<double > StdvectorDouble;
typedef std::vector<unsigned > StdvectorUnsigned;
typedef std::vector<bool > StdvectorBool;
typedef std::vector<std::string > StdvectorStdstring;
typedef std::vector<c_vector<double,3> > StdvectorC_vectordouble3;
typedef std::vector<c_vector<double,2> > StdvectorC_vectordouble2;
typedef std::vector<c_vector<unsigned,5> > StdvectorC_vectorunsigned5;
typedef std::vector<std::set<unsigned int> > StdvectorStdsetunsignedint;
typedef std::vector<std::vector<unsigned int> > StdvectorStdvectorunsignedint;
typedef std::vector<std::pair<unsigned int, unsigned int> > StdvectorStdpairunsignedintunsignedint;
typedef c_vector<double,2 > C_vectorDouble_2;
typedef c_vector<double,3 > C_vectorDouble_3;
typedef c_vector<unsigned,5 > C_vectorUnsigned_5;
    }
}
