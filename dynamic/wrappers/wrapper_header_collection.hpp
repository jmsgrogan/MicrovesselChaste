...
typedef std::map<int,std::string > MapInt_String;
...
typedef std::vector<std::pair<DimensionalChastePoint<2>, int> > VectorPairDimensionalChastePoint2int;
typedef std::vector<std::pair<DimensionalChastePoint<3>, int> > VectorPairDimensionalChastePoint3int;
typedef std::vector<std::pair<DimensionalChastePoint<3>, unsigned> > VectorPairDimensionalChastePoint3Unsigned;
typedef std::vector<std::pair<DimensionalChastePoint<3>, unsigned> > VectorPairDimensionalChastePoint3Unsigned;
typedef std::vector<std::pair<std::pair<int, int>, int> > VectorPairPairintintint;
typedef std::vector<std::map<std::string, double> > VectorMapStringDouble;
...
typedef std::vector<std::vector<Node<3>* > > VectorVectorNode3Ptr;
typedef std::vector<std::vector<Node<2>* > > VectorVectorNode2Ptr;
typedef std::vector<Node<3>* > VectorNode3Ptr;
typedef std::vector<Node<2>* > VectorNode2Ptr;
