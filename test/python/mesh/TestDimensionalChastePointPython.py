...
class TestDimensionalChastePoint(unittest.TestCase):
    ...
    def test_all_methods(self):
        ...
        print 10.0 * utility.pascal()
        
        # Make a point at the specified location
        #input_location = np.array((0.0, 1.0, 2.0))
        #point = microvessel.mesh.DimensionalChastePoint3(input_location, 1.e-6*utility.metre())
        #point2 = microvessel.mesh.DimensionalChastePoint3(2.0*input_location, 1.e-6*utility.metre())
        #print point.GetLocation(1.e-6*utility.metre())
        ...
        #translation_vector = microvessel.mesh.DimensionalChastePoint3(1.0, 2.0, 3.0, 1.e-6*utility.metre())
        ...
        #sprint point.GetLocation(1.e-6*utility.metre())
